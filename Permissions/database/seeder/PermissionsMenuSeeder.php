...
class PermissionsMenuSeeder extends Seeder
{
    ...
    public function data() : array
    {
        return [['id' => 1, 'permission_name' => '权限管理', 'parent_id' => 0, 'level' => '', 'route' => '/permissions', 'icon' => 'el-icon-cpu', 'module' => 'permissions', 'creator_id' => 1, 'permission_mark' => 'permission', 'component' => 'layout', 'redirect' => '/permissions/users', 'keepalive' => 1, 'type' => 1, 'hidden' => 1, 'sort' => 100, 'created_at' => 1587461455, 'updated_at' => 1632280164, 'children' => [
            ['id' => 2, 'permission_name' => '用户管理', 'parent_id' => 1, 'level' => '1', 'route' => '/permissions/users', 'icon' => 'el-icon-user', 'module' => 'permissions', 'creator_id' => 1, 'permission_mark' => 'users', 'component' => 'users', 'redirect' => '', 'keepalive' => 1, 'type' => 1, 'hidden' => 1, 'sort' => 13, 'created_at' => 1587461597, 'updated_at' => 1632280164, 'children' => [
            ...
            ['id' => 11, 'permission_name' => '角色管理', 'parent_id' => 1, 'level' => '1', 'route' => '/permissions/roles', 'icon' => 'el-icon-s-custom', 'module' => 'permissions', 'creator_id' => 1, 'permission_mark' => 'roles', 'component' => 'roles', 'redirect' => '', 'keepalive' => 1, 'type' => 1, 'hidden' => 1, 'sort' => 9, 'created_at' => 1587461939, 'updated_at' => 1632280164, 'children' => [
            ...
            ['id' => 19, 'permission_name' => '菜单管理', 'parent_id' => 1, 'level' => '1', 'route' => '/permissions/rules', 'icon' => 'el-icon-collection-tag', 'module' => 'permissions', 'creator_id' => 1, 'permission_mark' => 'permissions', 'component' => 'rules', 'redirect' => '', 'keepalive' => 1, 'type' => 1, 'hidden' => 1, 'sort' => 12, 'created_at' => 1587462147, 'updated_at' => 1632280164, 'children' => [
            ...
            ['id' => 27, 'permission_name' => '部门管理', 'parent_id' => 1, 'level' => '1', 'route' => '/permissions/departments', 'icon' => 'el-icon-monitor', 'module' => 'permissions', 'creator_id' => 1, 'permission_mark' => 'departments', 'component' => 'departments', 'redirect' => '', 'keepalive' => 1, 'type' => 1, 'hidden' => 1, 'sort' => 7, 'created_at' => 1587462488, 'updated_at' => 1632280164, 'children' => [
